/**
 * Update file request
 * PUT /file-requests/:file_request_id
 */
...
export const tool = {
  name: 'kinescope_:file_request_id_update_file_request__file_request_id',
  description: 'Update file request: PUT /file-requests/:file_request_id',
...
export const handler = async (client: KinescopeClient, args: any) => {
  ...
  const { file_request_id, ...bodyData } = validatedArgs;
