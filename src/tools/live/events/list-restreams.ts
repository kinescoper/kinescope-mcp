/**
 * List restreams
 * GET /live/events/:event_id/restreams/:restream_id
 */
...
export const tool = {
  name: 'kinescope_events_list_restreams_events',
  description: 'List restreams: GET /live/events/:event_id/restreams/:restream_id',
