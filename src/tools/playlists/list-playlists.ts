...
const schema = z.object({
    ...
    order: z.string().optional().describe('title, description, created_at, updated_at')
  });
...
export const tool = {
  name: 'kinescope_playlists_list_playlists',
  description: 'List playlists: GET /playlists',
