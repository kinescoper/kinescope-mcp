/**
 * Get Participant
 * GET /speak/rooms/:room_id/participants/:participant_id
 */
...
export const tool = {
  name: 'kinescope_rooms_get_participant_rooms',
  description: 'Get Participant: GET /speak/rooms/:room_id/participants/:participant_id',
