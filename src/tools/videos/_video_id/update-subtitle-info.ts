 ...
 * PATCH /videos/:video_id/subtitles/:subtitle_id
 */
...
export const tool = {
  name: 'kinescope_:video_id_update_subtitle_info__video_id',
  description: 'Update subtitle info: PATCH /videos/:video_id/subtitles/:subtitle_id',
...
export const handler = async (client: KinescopeClient, args: any) => {
  ...
  const { video_id, subtitle_id, ...bodyData } = validatedArgs;
